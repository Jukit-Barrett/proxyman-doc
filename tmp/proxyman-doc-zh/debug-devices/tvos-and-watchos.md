...
It's straightforward by following the [Proxyman iOS Simulator Guideline.](https://docs.proxyman.com/ios-simulator#ios-simulator-setup-guide)

### watchOS Physical Device

Follow the [iOS devices guideline](https://docs.proxyman.com/debug-devices/ios-device) to set HTTP Proxy and install the certificate to your host device.

...
1. Follow the Setup guide for your [iOS Devices](https://docs.proxyman.com/debug-devices/ios-device) or [iOS Simulators](https://docs.proxyman.com/debug-devices/ios-simulator) (Make sure we installed and trusted the certificate on your device)
...
<figure><img src="https://1856518738-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F-LlPt_6BePnJ3oK3saP1%2Fuploads%2FdYPaZhjGUBzUgxu9Z6Xx%2Fproxyman_capture_websocket_4.jpeg?alt=media&#x26;token=74d8aab6-5b85-4fc9-a753-00d1844d9190" alt=""><figcaption><p>Get Proxyman current IP</p></figcaption></figure>
...
<figure><img src="https://1856518738-files.gitbook.io/~/files/v0/b/gitbook-x-prod.appspot.com/o/spaces%2F-LlPt_6BePnJ3oK3saP1%2Fuploads%2FMlP1FUS4JbXjhNvqO5g1%2FScreenshot%202024-11-29%20at%201.17.23%E2%80%AFPM.jpg?alt=media&#x26;token=a4bf61f2-fe72-42f3-a1e6-9b5b1e2c1ac7" alt=""><figcaption><p>Capture Websocket from iOS with Proxyman</p></figcaption></figure>
...
* How to use: Read [automatic-setup](https://docs.proxyman.com/automatic-setup/automatic-setup "mention") to start your server on this Terminal -> Make a WS/WSS connection -> Proxyman automatically captures and decyrpts it ✅

## 5. Map Websocket from Localhost <-> Production

It's possible to map the WebSocket Traffic from localhost <-> Production. Please check out the [Map Remote Tool.](https://docs.proxyman.com/map-remote#7.4-map-websocket-from-localhost-to-production)

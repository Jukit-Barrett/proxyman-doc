...
If you would like to do Map Local Directory with **complicated rules,** you might check out [Scripting](https://docs.proxyman.com/scripting/script#1-whats-it) since it's easier to achieve the same result.

Please check out our [Snippet Code](https://docs.proxyman.com/scripting/snippet-code#2-common-on-request-and-response) to understand how to map a local file with Javascript Code.

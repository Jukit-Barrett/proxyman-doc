...
<div data-full-width="true"><figure><img src="images/Capture_HTTPS_Android_Emulator_proxyman_00ff276d.jpg" alt=""><figcaption><p>Capture and decrypt HTTPS from Android Emulators with Proxyman</p></figcaption></figure></div>

* Install Proxyman Certificate to the system-level Store.

<figure><img src="images/Screenshot_2025-02-10_at_15.12.07_fdbcd5ca.jpg" alt=""><figcaption><p>Install Proxyman Certificate to the system-level Store.</p></figcaption></figure>
...
![Create new Google APIs Android Emulators](images/Screen_Shot_2020-10-19_at_13_50_31_9b799855.png)

![Create a new Emulator (Google APIs)](images/Screen_Shot_2020-10-19_at_13_50_48_7bed702f.png)

<figure><img src="images/Screenshot_2025-09-19_at_20.01.37_62dfcde5.jpg" alt=""><figcaption></figcaption></figure>

3. Open Proxyman -> Certificate Menu -> Install Certificate on Android -> Emulators -> Click on the Override All Emulators button&#x20;

<figure><img src="images/Screenshot_2025-02-10_at_14.54.51_ba7da601.jpg" alt=""><figcaption><p>capture all HTTPS from Emulators with 1 click</p></figcaption></figure>

4. Wait until the Terminal completes

<figure><img src="images/Screenshot_2025-02-10_at_15.02.06_2cd28c56.png" alt=""><figcaption></figcaption></figure>

...
![](https://1856518738-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/assets%2F-LlPt_6BePnJ3oK3saP1%2F-MgziXuEudQDPNF3CBS_%2F-MgzivyyrfR93vyj9hMZ%2FScreen%20Shot%202021-08-13%20at%2020.37.39.png?alt=media\&token=2a834f02-f339-422c-80ad-b5520713e876)
...
{% hint style="info" %}
Check out the [built-in addons ](https://docs.proxyman.com/addons#2-built-in-addons)that Proxyman provides
{% endhint %}

* You can import a built-in library by using **require(@"lib/\<name.js>")**

{% hint style="info" %}
Check out the [built-in library](https://docs.proxyman.com/scripting/built-in-js-libraries) that Proxyman provides
{% endhint %}

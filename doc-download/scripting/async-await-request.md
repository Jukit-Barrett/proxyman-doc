...
* [GET Request with Query](https://docs.proxyman.com/snippet-code#get-request-with-query)
* [POST Request with JSON Body](https://docs.proxyman.com/snippet-code#post-request-with-json-body)
* [POST Request with application/x-www-form-urlencoded body](https://docs.proxyman.com/snippet-code#post-request-with-application-x-www-form-urlencoded-body)
* [PUT / PATCH / DELETE Request](https://docs.proxyman.com/snippet-code#put-patch-delete-request)

{% hint style="info" %}
Please checkout the [HTTP Snippet code](https://docs.proxyman.com/snippet-code#make-async-await-http-request) for more sample code.
{% endhint %}
